export const tokens = [
    { type: 'word', text: 'pu' },
    { type: 'word', text: 'bl' },
    { type: 'word', text: 'ic' , pd: true}, // public function __construct() {
    { type: 'word', text: 'func' },
    { type: 'word', text: 'tion' , pd: true},
    { type: 'func', text: '__cons' },
    { type: 'func', text: 'truct()' , pd:true},
    { type: 'symbol', text: '{' },
    { type: 'enter' },
    ...
    { type: 'symbol', text: '=' , pd:true},
    { type: 'link', text: 'https://github.com/Takuya0202', href: 'https://github.com/Takuya0202' },
    { type: 'enter' },
    ...
    { type: 'symbol', text: '=' , pd:true},
    { type: 'link', text: 'https://zenn.dev/amethyst', href: 'https://zenn.dev/amethyst' },
    { type: 'enter' },
